...
export const getDerivationPath = (walletAccount: number, walletIndex: number, network: Network): string => {
  const DERIVATION_PATHES = {
    [Network.Mainnet]: ['m', "44'", "931'", `${walletAccount}'`, 0, walletIndex],
    [Network.Testnet]: ['m', "44'", "931'", `${walletAccount}'`, 0, walletIndex],
    [Network.Stagenet]: ['m', "44'", "931'", `${walletAccount}'`, 0, walletIndex]
  }
