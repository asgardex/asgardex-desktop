...
// BIP44 compliant - XRP uses coin type 144
export const getDerivationPath = (walletAccount: number, network: Network): string => {
  const DERIVATION_PATHS = {
    [Network.Mainnet]: ['m', "44'", "144'", `${walletAccount}'`, '0/'],
    [Network.Testnet]: ['m', "44'", "144'", `${walletAccount}'`, '0/'],
    [Network.Stagenet]: ['m', "44'", "144'", `${walletAccount}'`, '0/']
  }
