...
// BIP44 compliant - TRON coin type is 195
export const getDerivationPath = (walletAccount: number, network: Network): string => {
  const DERIVATION_PATHS = {
    [Network.Mainnet]: ['m', "44'", "195'", `${walletAccount}'`, '0/'],
    [Network.Testnet]: ['m', "44'", "195'", `${walletAccount}'`, '0/'],
    [Network.Stagenet]: ['m', "44'", "195'", `${walletAccount}'`, '0/']
  }
