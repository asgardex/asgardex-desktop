...
describe('Savers routes', () => {
  ...
  describe('Earn routes', () => {
    ...
    it('asset / keystore', () => {
      expect(earn.path({ asset: 'BSC.BNB', walletType: 'keystore' })).toEqual('/pools/savers/bsc.bnb/earn/keystore')
    })
    it('asset / ledger', () => {
      expect(earn.path({ asset: 'BSC.BNB', walletType: 'ledger' })).toEqual('/pools/savers/bsc.bnb/earn/ledger')
    })
  })
  ...
  describe('Withdraw routes', () => {
    ...
    it('asset / keystore', () => {
      expect(withdraw.path({ asset: 'BSC.BNB', walletType: 'keystore' })).toEqual(
        '/pools/savers/bsc.bnb/withdraw/keystore'
      )
    })
    it('asset / ledger', () => {
      expect(withdraw.path({ asset: 'BSC.BNB', walletType: 'ledger' })).toEqual('/pools/savers/bsc.bnb/withdraw/ledger')
    })
  })
})
