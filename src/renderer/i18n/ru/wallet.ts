...
const wallet: WalletMessages = {
  ...
  'wallet.imports.watchOnly.title': 'Импортировать Watch-Only Кошельки',
  'wallet.imports.watchOnly.description': 'Импортируйте публичные ключи с автономного компьютера для мониторинга балансов без приватных ключей',
  'wallet.imports.watchOnly.selectFile': 'Выберите файл watch кошельков',
  'wallet.imports.watchOnly.success': 'Watch-only кошельки успешно импортированы!',
  'wallet.imports.watchOnly.imported.count': 'Импортировано {count} кошельков',
