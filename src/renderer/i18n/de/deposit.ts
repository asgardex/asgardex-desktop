...
const deposit: DepositMessages = {
  ...
  'deposit.interact.actions.whitelist': 'Weiße Liste',
  ...
  'deposit.interact.actions.checkMayaname': 'Verfügbarkeit prüfen',
  'deposit.interact.actions.addBondProvider': 'Bond Provider hinzufügen',
  'deposit.interact.actions.getQuote': 'Get Quote',
  'deposit.interact.nodeFee.placeholder': 'Gib einen %-Wert ein, das Memo wird automatisch mit Basispunkten befüllt',
  'deposit.interact.percentage.placeholder': 'Prozentsatz eingeben (0-100)',
  'deposit.interact.percentage.error': 'Der Prozentsatz muss zwischen 0 und 100 liegen',
  'deposit.poolTransactionWarning': 'Sende Pool-Transaktion auf {protocol}. Nur für Entwickler – Risiko von Geldverlust',
  'deposit.transferToken': 'Token {ticker} übertragen',
