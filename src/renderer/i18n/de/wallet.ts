...
const wallet: WalletMessages = {
  ...
  'wallet.nav.approvals': 'Freigaben',
  'wallet.approvals.title': 'Router-Freigaben',
  'wallet.approvals.description':
    'ERC-20-Freigaben für THORChain- und MAYAChain-Router prüfen, erteilen oder widerrufen. Die Freigabe ist in der Regel einmalig pro Token und Protokoll.',
  'wallet.approvals.check': 'Freigabe prüfen',
  'wallet.approvals.revoke': 'Widerrufen',
  'wallet.approvals.unlimited': 'Unbegrenzt',
  'wallet.approvals.current': 'Aktuelle Freigabe',
  'wallet.approvals.amount': 'Freigabebetrag',
  'wallet.approvals.noRouter': 'Keine Router-Adresse für diese Chain verfügbar',
  'wallet.approvals.selectToken': 'Token wählen',
  'wallet.approvals.resetWarning':
    'Einige Token (z. B. USDT) können zwei Signaturen erfordern: Freigabe auf null zurücksetzen, dann neuen Betrag setzen.',
  'wallet.approvals.raw': 'Rohwert',
  'wallet.approvals.none': 'Keine',
  'wallet.approvals.chain': 'Chain',
  'wallet.approvals.owner': 'Eigentümer-Adresse',
  'wallet.approvals.spender': 'Router (Spender)',
  'wallet.approvals.wallet': 'Wallet',
  'wallet.approvals.selectWallet': 'Wallet wählen',
  ...
  'wallet.vultisig.import.error.duplicate': 'Dieser lokale Vault-Share existiert bereits',
  'wallet.vultisig.import.replace.description': 'Durch die Bestätigung wird der vorhandene lokale Vault-Share ersetzt.',
  'wallet.vultisig.import.replace.confirm': 'Ersetzen',
