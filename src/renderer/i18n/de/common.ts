...
const common: CommonMessages = {
  ...
  'common.aliasChain': 'Alias-keten',
  'common.aliasAddress': 'Alias-adres',
  'common.expiry': 'Vervaldatum',
  'common.isUpdate': 'THORName bijwerken',
  'common.address.self': 'Selbst',
  'common.to': 'Zu',
  'common.from': 'Von',
  'common.filterValue': 'Filter waarden onder 1$',
  ...
  'common.privateData': 'Privégegevens',
  'common.date': 'Datum',
  ...
  'common.asset.quickSelect': 'Snel selecteren L1',
  ...
  'common.time.title': 'Tijd',
  'common.inbound.time': 'Inkomend',
  'common.outbound.time': 'Uitgaand',
