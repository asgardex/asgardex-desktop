...
const wallet: WalletMessages = {
  ...
  'wallet.approvals.current': 'Current allowance',
  'wallet.approvals.amount': 'Approve amount',
  'wallet.approvals.noRouter': 'No router address available for this chain',
  'wallet.approvals.selectToken': 'Select token',
  'wallet.approvals.resetWarning':
    'Some tokens (e.g. USDT) may require two signatures: reset allowance to zero, then set the new amount.',
  'wallet.approvals.raw': 'Raw',
  'wallet.approvals.none': 'None',
  'wallet.approvals.chain': 'Chain',
  'wallet.approvals.owner': 'Owner address',
  'wallet.approvals.spender': 'Router (spender)',
  'wallet.approvals.wallet': 'Wallet',
  'wallet.approvals.selectWallet': 'Select wallet',
  ...
  'wallet.select.error': 'Could not switch wallet. Please try again.',
  ...
  'wallet.vultisig.import.replace.description': 'Confirming will replace the existing local vault share.',
  'wallet.vultisig.import.replace.confirm': 'Replace',
