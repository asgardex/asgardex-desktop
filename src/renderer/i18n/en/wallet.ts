...
const wallet: WalletMessages = {
  ...
  'wallet.imports.watchOnly.title': 'Import Watch-Only Wallets',
  'wallet.imports.watchOnly.description': 'Import public keys from an offline computer to monitor balances without private keys',
  'wallet.imports.watchOnly.selectFile': 'Select watch wallets file',
  'wallet.imports.watchOnly.success': 'Watch-only wallets imported successfully!',
  'wallet.imports.watchOnly.imported.count': '{count} wallets imported',
