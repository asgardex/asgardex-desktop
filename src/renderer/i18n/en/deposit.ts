...
const deposit: DepositMessages = {
  ...
  'deposit.interact.subtitle': 'Interact with {chain}Chain',
  ...
  'deposit.interact.actions.whitelist': 'Whitelist',
  ...
  'deposit.interact.nodeFee.placeholder': 'Enter a % value, memo will populate with Basis Points automatically',
  'deposit.interact.percentage.placeholder': 'Enter percentage (0-100)',
  'deposit.interact.percentage.error': 'Percentage must be between 0 and 100',
  'deposit.poolTransactionWarning': 'Send pool transaction on {protocol}. Dev use only or risk losing your funds',
  'deposit.transferToken': 'Transfer token {ticker}',
