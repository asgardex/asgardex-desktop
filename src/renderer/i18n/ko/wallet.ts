...
const wallet: WalletMessages = {
  ...
  'wallet.imports.watchOnly.title': 'Watch-Only 지갑 가져오기',
  'wallet.imports.watchOnly.description': '개인 키 없이 잔액을 모니터링하기 위해 오프라인 컴퓨터에서 공개 키를 가져오기',
  'wallet.imports.watchOnly.selectFile': 'Watch 지갑 파일 선택',
  'wallet.imports.watchOnly.success': 'Watch-only 지갑을 성공적으로 가져왔습니다!',
  'wallet.imports.watchOnly.imported.count': '{count}개의 지갑을 가져왔습니다',
