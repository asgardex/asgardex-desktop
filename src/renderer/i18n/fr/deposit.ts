...
const deposit: DepositMessages = {
  ...
  'deposit.interact.actions.whitelist': 'Liste blanche',
  ...
  'deposit.interact.actions.checkMayaname': 'Vérifier la disponibilité',
  'deposit.interact.actions.addBondProvider': 'Ajouter un fournisseur de caution',
  'deposit.interact.actions.getQuote': 'Get Quote',
  'deposit.interact.nodeFee.placeholder': 'Saisissez une valeur en %, le mémo sera automatiquement rempli en points de base',
  'deposit.interact.percentage.placeholder': 'Saisissez un pourcentage (0-100)',
  'deposit.interact.percentage.error': 'Le pourcentage doit être compris entre 0 et 100',
  'deposit.poolTransactionWarning': 'Envoyer une transaction de pool sur {protocol}. Réservé aux développeurs, risque de perte de fonds',
  'deposit.transferToken': 'Transférer le jeton {ticker}',
  ...
  'deposit.poolTransactionInfo':
    "Lorsque cette option est activée, l'envoi s'effectue via le contrat de routeur {protocol} (depositWithExpiry), utilisé pour les interactions avec le pool comme l'ajout de liquidité ou le bonding. Laissez DÉSACTIVÉ pour un transfert de jetons normal.",
