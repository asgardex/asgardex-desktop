...
const wallet: WalletMessages = {
  ...
  'wallet.imports.watchOnly.title': 'Importer Portefeuilles Watch-Only',
  'wallet.imports.watchOnly.description': 'Importer des clés publiques depuis un ordinateur hors ligne pour surveiller les soldes sans clés privées',
  'wallet.imports.watchOnly.selectFile': 'Sélectionner le fichier de portefeuilles watch',
  'wallet.imports.watchOnly.success': 'Portefeuilles watch-only importés avec succès!',
  'wallet.imports.watchOnly.imported.count': '{count} portefeuilles importés',
