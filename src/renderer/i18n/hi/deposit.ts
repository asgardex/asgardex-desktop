...
const deposit: DepositMessages = {
  ...
  'deposit.interact.actions.whitelist': 'श्वेत सूची',
  ...
  'deposit.interact.nodeFee.placeholder': '% मान दर्ज करें, मेमो स्वतः बेसिस पॉइंट्स से भर जाएगा',
  'deposit.interact.percentage.placeholder': 'प्रतिशत दर्ज करें (0-100)',
  'deposit.interact.percentage.error': 'प्रतिशत 0 और 100 के बीच होना चाहिए',
  'deposit.poolTransactionWarning': '{protocol} पर पूल लेन-देन भेजें। केवल डेवलपर उपयोग के लिए, अन्यथा धन खोने का जोखिम',
  'deposit.transferToken': 'टोकन {ticker} स्थानांतरित करें',
