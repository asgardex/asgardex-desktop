...
const wallet: WalletMessages = {
  ...
  'wallet.nav.approvals': 'अनुमतियाँ',
  'wallet.approvals.title': 'राउटर अनुमतियाँ',
  'wallet.approvals.description':
    'THORChain और MAYAChain राउटर के लिए ERC-20 अनुमतियाँ जाँचें, स्वीकृत करें या रद्द करें। अनुमति आमतौर पर प्रति टोकन और प्रोटोकॉल एक बार होती है।',
  'wallet.approvals.check': 'अनुमति जाँचें',
  'wallet.approvals.revoke': 'रद्द करें',
  'wallet.approvals.unlimited': 'असीमित',
  'wallet.approvals.current': 'वर्तमान अनुमति',
  'wallet.approvals.amount': 'स्वीकृत राशि',
  'wallet.approvals.noRouter': 'इस चेन के लिए कोई राउटर पता उपलब्ध नहीं',
  'wallet.approvals.selectToken': 'टोकन चुनें',
  'wallet.approvals.resetWarning':
    'कुछ टोकन (जैसे USDT) के लिए दो हस्ताक्षर चाहिए हो सकते हैं: अनुमति शून्य करें, फिर नई राशि सेट करें।',
  'wallet.approvals.raw': 'कच्चा',
  'wallet.approvals.none': 'कोई नहीं',
  'wallet.approvals.chain': 'चेन',
  'wallet.approvals.owner': 'स्वामी पता',
  'wallet.approvals.spender': 'राउटर (spender)',
  'wallet.approvals.wallet': 'वॉलेट',
  'wallet.approvals.selectWallet': 'वॉलेट चुनें',
  ...
  'wallet.vultisig.import.error.duplicate': 'यह स्थानीय vault शेयर पहले से मौजूद है',
  'wallet.vultisig.import.replace.description': 'पुष्टि करने पर मौजूदा स्थानीय vault शेयर बदल दिया जाएगा।',
  'wallet.vultisig.import.replace.confirm': 'बदलें',
