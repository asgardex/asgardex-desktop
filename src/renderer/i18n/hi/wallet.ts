...
const wallet: WalletMessages = {
  ...
  'wallet.imports.watchOnly.title': 'Watch-Only वॉलेट आयात करें',
  'wallet.imports.watchOnly.description': 'प्राइवेट कुंजी के बिना बैलेंस की निगरानी के लिए ऑफ़लाइन कंप्यूटर से सार्वजनिक कुंजी आयात करें',
  'wallet.imports.watchOnly.selectFile': 'Watch वॉलेट फ़ाइल चुनें',
  'wallet.imports.watchOnly.success': 'Watch-only वॉलेट सफलतापूर्वक आयात किए गए!',
  'wallet.imports.watchOnly.imported.count': '{count} वॉलेट आयात किए गए',
