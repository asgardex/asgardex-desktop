...
const common: CommonMessages = {
  ...
  'common.addAddress.missing': 'Elige una cadena e introduce una dirección y un nombre',
  'common.addAddress.duplicate': 'Esta dirección ya está guardada',
  'common.stored': 'Guardado',
  ...
  'common.useWalletAddress': 'Usar dirección de billetera',
  ...
  'common.registerOrUpdate': 'Registrar / Actualizar',
  ...
  'common.noQuoteReturned': 'No se devolvió ninguna cotización',
  'common.quoteFailed': 'Cotización fallida',
  ...
  'common.protocolSwitch.switchTo': 'Cambiar a {protocol}',
