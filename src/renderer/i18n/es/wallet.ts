...
const wallet: WalletMessages = {
  ...
  'wallet.imports.watchOnly.title': 'Importar Carteras Watch-Only',
  'wallet.imports.watchOnly.description': 'Importar claves públicas desde una computadora sin conexión para monitorear saldos sin claves privadas',
  'wallet.imports.watchOnly.selectFile': 'Seleccionar archivo de carteras watch',
  'wallet.imports.watchOnly.success': '¡Carteras watch-only importadas con éxito!',
  'wallet.imports.watchOnly.imported.count': '{count} carteras importadas',
