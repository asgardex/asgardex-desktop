...
const wallet: WalletMessages = {
  ...
  'wallet.nav.approvals': 'Aprobaciones',
  'wallet.approvals.title': 'Aprobaciones del router',
  'wallet.approvals.description':
    'Consulta, aprueba o revoca autorizaciones ERC-20 para los routers de THORChain y MAYAChain. La aprobación suele ser única por token y protocolo.',
  'wallet.approvals.check': 'Comprobar autorización',
  'wallet.approvals.revoke': 'Revocar',
  'wallet.approvals.unlimited': 'Ilimitado',
  'wallet.approvals.current': 'Autorización actual',
  'wallet.approvals.amount': 'Cantidad a aprobar',
  'wallet.approvals.noRouter': 'No hay dirección de router disponible para esta cadena',
  'wallet.approvals.selectToken': 'Seleccionar token',
  'wallet.approvals.resetWarning':
    'Algunos tokens (p. ej. USDT) pueden requerir dos firmas: restablecer la autorización a cero y luego establecer el nuevo importe.',
  'wallet.approvals.raw': 'En bruto',
  'wallet.approvals.none': 'Ninguna',
  'wallet.approvals.chain': 'Cadena',
  'wallet.approvals.owner': 'Dirección del propietario',
  'wallet.approvals.spender': 'Router (spender)',
  'wallet.approvals.wallet': 'Cartera',
  'wallet.approvals.selectWallet': 'Seleccionar cartera',
  ...
  'wallet.vultisig.import.error.duplicate': 'Esta copia local del vault ya existe',
  'wallet.vultisig.import.replace.description': 'Al confirmar se reemplazará la copia local del vault existente.',
  'wallet.vultisig.import.replace.confirm': 'Reemplazar',
