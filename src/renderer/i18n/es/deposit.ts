...
const deposit: DepositMessages = {
  ...
  'deposit.interact.actions.checkMayaname': 'Comprobar disponibilidad',
  'deposit.interact.actions.addBondProvider': 'Añadir proveedor de bonos',
  'deposit.interact.actions.getQuote': 'Get Quote',
  'deposit.interact.nodeFee.placeholder': 'Introduzca un valor en %, el memo se completará automáticamente con puntos básicos',
  'deposit.interact.percentage.placeholder': 'Introduzca un porcentaje (0-100)',
  'deposit.interact.percentage.error': 'El porcentaje debe estar entre 0 y 100',
  'deposit.poolTransactionWarning': 'Enviar transacción de pool en {protocol}. Solo para desarrolladores, riesgo de perder fondos',
  'deposit.transferToken': 'Transferir token {ticker}',
  ...
  'deposit.poolTransactionInfo':
    'Cuando está habilitado, se envía a través del contrato del enrutador de {protocol} (depositWithExpiry), utilizado para interacciones con el pool como añadir liquidez o realizar bonding. Déjelo DESACTIVADO para una transferencia normal de tokens.',
