...
type WalletMessageKey =
  ...
  | 'wallet.imports.watchOnly.title'
  | 'wallet.imports.watchOnly.description'
  | 'wallet.imports.watchOnly.selectFile'
  | 'wallet.imports.watchOnly.success'
  | 'wallet.imports.watchOnly.imported.count'
