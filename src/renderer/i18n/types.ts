...
export type CommonMessageKey =
  ...
  | 'common.addAddress'
  | 'common.addAddress.missing'
  | 'common.addAddress.duplicate'
  | 'common.stored'
...
type WalletMessageKey =
  ...
  | 'wallet.nav.savers'
  | 'wallet.nav.runepool'
  | 'wallet.nav.approvals'
  | 'wallet.approvals.title'
  | 'wallet.approvals.description'
  | 'wallet.approvals.check'
  | 'wallet.approvals.revoke'
  | 'wallet.approvals.unlimited'
  | 'wallet.approvals.current'
  | 'wallet.approvals.amount'
  | 'wallet.approvals.noRouter'
  | 'wallet.approvals.selectToken'
  | 'wallet.approvals.resetWarning'
  | 'wallet.approvals.raw'
  | 'wallet.approvals.none'
  | 'wallet.approvals.chain'
  | 'wallet.approvals.owner'
  | 'wallet.approvals.spender'
  | 'wallet.approvals.wallet'
  | 'wallet.approvals.selectWallet'
  ...
  | 'wallet.vultisig.import.replace.description'
  | 'wallet.vultisig.import.replace.confirm'
...
type BondsMessageKey =
  ...
  | 'bonds.validations.nodeNotFound'
  | 'bonds.validations.bondStatusActive'
  | 'bonds.tooltip.removeFromWatchlist'
  | 'bonds.tooltip.addToWatchlist'
  | 'bonds.mainnetOnly'
  | 'bonds.provider.tab.bondProvider'
  | 'bonds.provider.tab.nodeOperator'
  | 'bonds.provider.findNodeHint'
  | 'bonds.provider.nextChurn'
  | 'bonds.provider.yourBond'
  | 'bonds.provider.freeToBond'
  | 'bonds.provider.idleInWallet'
  | 'bonds.provider.paidLastChurn'
  | 'bonds.provider.history'
  | 'bonds.provider.node.paidLastChurn'
  | 'bonds.provider.node.earning'
  | 'bonds.provider.node.notEarning'
  | 'bonds.provider.node.notEarningLocked'
  | 'bonds.provider.bondMore'
  | 'bonds.provider.unbond'
  | 'bonds.provider.modal.availableInWallet'
  | 'bonds.provider.modal.unbondMax'
  | 'bonds.provider.modal.bondAfter'
  | 'bonds.provider.modal.startsPaying'
  | 'bonds.provider.modal.nextChurn'
  | 'bonds.provider.modal.bondLeft'
  | 'bonds.provider.modal.fundsReturn'
  | 'bonds.provider.modal.immediately'
  | 'bonds.provider.modal.memo'
  | 'bonds.provider.modal.thorchainTx'
  | 'bonds.provider.modal.signSend'
  | 'bonds.provider.modal.signUnbond'
  ...
  | 'bonds.provider.empty.step1.desc'
  | 'bonds.provider.empty.step2.title'
  | 'bonds.provider.empty.step2.desc'
  | 'bonds.provider.empty.step3.title'
  | 'bonds.provider.empty.step3.desc'
  | 'bonds.provider.detail.back'
  | 'bonds.provider.detail.share'
  | 'bonds.provider.detail.operator'
  | 'bonds.provider.detail.youOperate'
  | 'bonds.provider.detail.viewOnExplorer'
  | 'bonds.provider.detail.unbondLocked'
  | 'bonds.provider.detail.churnInfo'
  | 'bonds.provider.detail.noHistoryYet'
  | 'bonds.provider.detail.nodeApy'
  | 'bonds.provider.detail.earningsTitle'
  | 'bonds.provider.detail.earnings'
  | 'bonds.provider.detail.churnsAgo'
  | 'bonds.provider.detail.now'
  | 'bonds.provider.detail.providersTitle'
  | 'bonds.provider.detail.you'
  | 'bonds.provider.detail.others'
  | 'bonds.provider.detail.slots'
  | 'bonds.provider.detail.providersCount'
  | 'bonds.provider.detail.bondedIdle'
  | 'bonds.provider.detail.bondSplit'
  | 'bonds.provider.detail.bondedAmount'
  | 'bonds.provider.rewards.title'
  | 'bonds.provider.rewards.churnCount'
  | 'bonds.provider.rewards.avgPerChurn'
  | 'bonds.provider.rewards.allNodes'
  | 'bonds.provider.rewards.perNode'
  | 'bonds.provider.rewards.lastPayouts'
  | 'bonds.provider.rewards.byNode'
  | 'bonds.provider.rewards.exportCsv'
  | 'bonds.provider.rewards.perChurn'
  | 'bonds.provider.rewards.totalPaid'
  | 'bonds.provider.rewards.churnsPaid'
  | 'bonds.provider.rewards.standby'
  | 'bonds.provider.data.unavailable'
  | 'bonds.operator.detail.back'
  | 'bonds.operator.detail.fee'
  | 'bonds.operator.bondUnderManagement'
  | 'bonds.operator.nodesAndProviders'
  | 'bonds.operator.nodeSummary'
  | 'bonds.operator.removeMonitored'
  | 'bonds.operator.empty'
  | 'bonds.operator.addNode.title'
  | 'bonds.operator.addNode.description'
  | 'bonds.operator.addNode.label'
...
type SettingMessageKey =
  ...
  | 'settings.wallet.hd.find.rangeLabel'
  | 'settings.wallet.hd.find.rangeFrom'
  | 'settings.wallet.hd.find.rangeTo'
  | 'settings.wallet.hd.find.rangeHint'
