...
export const TransactionTracker: React.FC<TransactionTrackerProps> = ({ transactionTrackingService, className }) => {
  const intl = useIntl()
    ...
    <div className={clsx('rounded-lg border border-gray1 dark:border-gray1d bg-bg1 dark:bg-bg1d', className)}>
      ...
      <div className="p-2 border-b border-gray1 dark:border-gray1d">
        <div className="flex items-center space-x-2">
          <ClockIcon className="w-3 h-3 text-text2 dark:text-text2d" />
