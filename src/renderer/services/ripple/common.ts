...
/**
 * Stream to create an observable `XRPchainClient` depending on existing phrase in keystore
 *
 * Whenever a phrase has been added to keystore, a new `XRPchainClient` will be created.
 * By the other hand: Whenever a phrase has been removed, `ClientState` is set to `initial`
 * A `XRPchainClient` will never be created as long as no phrase is available
 */
 ...
 * `Address`
 */
const addressUI$: C.WalletAddress$ = C.addressUI$(client$, XRPChain)
